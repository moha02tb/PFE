...
tableau de bord administrateur React/Vite et une application mobile Expo/React Native. Le backend porte
la logique commune, tandis que les deux interfaces répondent à des usages complémentaires : la
consultation citoyenne et l'administration des données.
...
Le projet vise à réaliser une plateforme complète autour des pharmacies et des pharmacies de garde. Les
...
fonctionnels, les besoins non fonctionnels et les règles de gestion. Le troisième est consacré à la
conception : architecture, modèle de données, diagrammes \gls{uml} et sécurité. Le quatrième décrit la
réalisation technique, l'intégration API, la configuration, les tests et les difficultés rencontrées. Une
