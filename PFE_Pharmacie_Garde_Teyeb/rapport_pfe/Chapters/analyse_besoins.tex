...
\begin{longtable}{L{4cm}L{10cm}}
    ...
    Assistant de premiers secours & Réponse aux questions de premiers secours, récupération d'informations fiable, détection de confiance, mécanismes de sécurité médicale et fallback prudent. \\
