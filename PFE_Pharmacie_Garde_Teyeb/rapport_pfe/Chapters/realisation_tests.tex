...
\begin{lstlisting}[caption={Exemple de requete a l'API de l'assistant}]
POST /answer
Content-Type: application/json

{
  "query": "Comment faire face a l'ettouffement?",
  "top_k": 5
}
\end{lstlisting}

\begin{lstlisting}[caption={Structure de la reponse de l'assistant}]
{
  "query": "Comment faire face a l'ettouffement?",
...
Les captures suivantes presentent les principales interfaces realisees pour le tableau de bord
...
\begin{figure}[H]
    ...
    \caption{Ecran de connexion du tableau de bord administrateur}
...
\begin{figure}[H]
    ...
    \caption{Vue cartographique du reseau de pharmacies}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.32\textwidth}
        ...
        \captionof{figure}{Catalogue mobile des medicaments}
