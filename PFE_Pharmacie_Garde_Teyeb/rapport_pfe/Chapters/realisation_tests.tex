...
\visualslot{Écran mobile de l'assistant de premiers secours}
{Capture réelle à insérer depuis l'application mobile montrant une question et une réponse de l'assistant.}
{fig:screenshot-mobile-chatbot}
