...
Les choix techniques ont été retenus en fonction des responsabilités de chaque partie du système. Le
backend devait exposer des routes REST structurées, contrôler les accès et centraliser les règles métier.
L'administration web devait offrir une gestion rapide des pharmacies, gardes, imports et journaux d'audit.
L'application mobile devait rester utilisable dans un parcours citoyen court : rechercher, filtrer,
localiser et consulter les informations essentielles.
